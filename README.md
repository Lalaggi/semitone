...
- **Lyrics** — 9 providers (PaxSenix, BetterLyrics, SimpMusic, LyricsPlus, LRCLib, NetEase, Megalobiz, Genius, Musixmatch), synced lyrics with word-by-word highlighting, auto-scroll, click-to-seek, auto-select best match
