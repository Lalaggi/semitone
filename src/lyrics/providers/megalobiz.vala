namespace G4 {
    ...
    public async LyricsCandidate? provider_fetch_megalobiz (Music music, int duration_ms, Settings settings, int index) {
        ...
        try {
            ...
            var lrc_body = yield lyrics_http_get_with_headers (lrc_url, headers);
